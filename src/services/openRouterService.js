...
class OpenRouterService {
  ...
  async autoGrade({ testCase, result }) {
    try {
      const gradingPrompt = `You are an expert evaluator. You will be given a test case with a prompt and the model's response. Evaluate the quality of the response.
